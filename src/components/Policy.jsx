...
const Policy = () => {
  return (
    <section
      id="policy"
      className="relative font-mont grid gap-16 lg:grid-cols-2 items-center bg-cover bg-center bg-secondLens text-white py-16 px-5 md:px-20 layout text-center lg:text-left"
    >
      <div>
        ...
        <div className="flex gap-[7%] items-start justify-center lg:justify-start">
          ...
          <img
            src={whiteStar}
            alt="star"
            className="animate-pulse hidden lg:block w-5"
          />
        </div>
        ...
        <div className="flex justify-end mb-4">
          <img
            src={purpleStar}
            alt="star"
            className="animate-pulse hidden lg:block w-5 mr-[-17%] object-contain"
          />
        </div>
        ...
        <div className="flex justify-end mb-7">
          <img
            src={purpleStar}
            alt="star"
            className="animate-pulse w-3 lg:hidden"
          />
        </div>
        <motion.div
          ...
          viewport={{ once: true }}
          className="border border-primary sm:p-10 p-4"
        >
      ...
      <div className="w-full flex justify-center lg:justify-start">
        ...
        <img
          src={whiteStar}
          alt="star"
          className="animate-pulse w-3 lg:w-5 absolute sm:bottom-[32%] sm:right-[39%] bottom-[34%] right-[33%] lg:right-[18%] lg:bottom-[68%] 2xl:bottom-[77%] 2xl:right-[18%] policyStar"
        />
        <img
          src={purpleStar}
          alt="star"
          className="animate-pulse w-3 absolute lg:w-5 left-[12%] bottom-[31%] sm:bottom-[32%] sm:left-[27%] lg:hidden"
        />
        <img
          src={whiteStar}
          alt="star"
          className="animate-pulse w-3 absolute lg:w-5 bottom-[12%] left-[23%] sm:left-[36%] lg:left-[60%] lg:bottom-[34%]"
        />
        <img
          src={whiteStar}
          alt="star"
          className="animate-pulse w-3 absolute lg:w-5 bottom-[10%] left-[74%] md:left-[68%] lg:bottom-[30%] lg:left-[91%] 2xl:left-[94%] 2xl:bottom-[23%] privacyStar"
        />
      </div>
    </section>
  );
