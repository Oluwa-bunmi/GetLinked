    ...
    <section>
      ...
      <nav className="hidden primaryGradient fixed w-full z-[1000] px-5 md:px-20  font-mont lg:flex justify-between items-center pt-8 pb-4">
        ...
        <div className="hidden lg:flex gap-28 text-[16px] text-white items-center">
          ...
          <button class="w-[172px] h-[53px] before:duration-300 before:transition before:ease-in-out rounded hover:opacity-80 hover:before:opacity-80 bg-buttonGradient before:inset-[2px] before:absolute relative before:bg-[#150E28] outline-none">
        ...
        <div className="md:shadow-regshadow xl:bg-[#ffffff08] rounded-[12px]">
          ...
          >
            ...
            <div className=" flex flex-col gap-6">
              <h1 className="font-mont text-xl sm:text-[24px]">CREATE YOUR ACCOUNT</h1>
              ...
              <div className="flex gap-2 flex-nowrap items-center w-full">
                <input
                  ...
                  id="agreement"
                  name="agreement"
                  checked={values.agreement} // Bind checked attribute
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                <label
